...
namespace Alachisoft.NCache.PersistenceProvider
{
    ...
    public interface IPersistenceProvider : IDsPersistenceProvider,IDisposable
    {
        ...
        /// Add into database
        /// </summary>
        /// <param name="providerItems">The key value pair to add in to cache</param>
        void Add(IDictionary<string, ProviderItemBase> providerItems);
        /// <summary>
        /// Insert into database
        /// </summary>
        /// <param name="providerItems">The key value pair to Insert in to cache</param>
        void Insert(IDictionary<string,ProviderItemBase> providerItems);
        /// <summary>
