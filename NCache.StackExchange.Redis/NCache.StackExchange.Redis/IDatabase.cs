...
namespace NCache.StackExchange.Redis
{
    ...
    public interface IDatabase : IDatabaseAsync
    {
        ...
        /// <returns>Yields all elements of the hash matching the pattern.</returns>
        /// <remarks>https://redis.io/commands/hscan</remarks>
        IEnumerable<HashEntry> HashScan(RedisKey key, RedisValue pattern = default(RedisValue), int pageSize = 250, long cursor = 0, int pageOffset = 0, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>Yields all matching elements of the set.</returns>
        /// <remarks>https://redis.io/commands/sscan</remarks>
        IEnumerable<RedisValue> SetScan(RedisKey key, RedisValue pattern = default(RedisValue), int pageSize = 250, long cursor = 0, int pageOffset = 0, CommandFlags flags = CommandFlags.None);
