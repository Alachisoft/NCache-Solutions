...
$env:ESHOP_EXTERNAL_DNS_NAME_OR_IP = "20.200.20.103"
$env:ESHOP_AZURE_STORAGE_CATALOG_URL ="http://20.200.20.103:5101/api/v1/catalog/items/[0]/pic/"
$env:ESHOP_AZURE_STORAGE_MARKETING_URL ="http://20.200.20.103:5110/api/v1/campaigns/[0]/pic/"
$env:ESHOP_OCELOT_VOLUME_SPEC ="C:\app\configuration"
$env:INSTRUMENTATION_KEY="eShopNCache"
$env:ORCHESTRATOR_TYPE="SF"
