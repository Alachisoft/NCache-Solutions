    ...
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new List<ApiResource>
            {
                ...
                new ApiResource("webstatus","Web Status registration Service")
            };
        }
        ...
        public static IEnumerable<Client> GetClients(Dictionary<string, string> clientsUrl)
        {
            var list =  new List<Client>
            {
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["LocationsApi"]}/swagger",
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["MarketingApi"]}/swagger",
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["BasketApi"]}/swagger",
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["OrderingApi"]}/swagger",
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["MobileShoppingAgg"]}/swagger",
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["WebShoppingAgg"]}/swagger",
                ...
                new Client
                {
                    ...
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    ClientUri = $"{clientsUrl["WebhooksApi"]}/swagger",
                ...
                {
                    ClientId = "webstatus",
                    ClientName = "Web Status Client",
                    ClientUri = $"{clientsUrl["Webstatus"]}",                             // public uri of the client
                    AllowedGrantTypes = GrantTypes.Implicit,
                    AllowAccessTokensViaBrowser = true,
                    RedirectUris = new List<string>
                    {
                        $"{clientsUrl["Webstatus"]}/hc-ui"
                    },
                    PostLogoutRedirectUris = new List<string>
                    {
                        $"{clientsUrl["Webstatus"]}/hc-ui/oauth2-redirect.html"
                    },
                    AllowedScopes = new List<string>
                    {
                        "webstatus"
